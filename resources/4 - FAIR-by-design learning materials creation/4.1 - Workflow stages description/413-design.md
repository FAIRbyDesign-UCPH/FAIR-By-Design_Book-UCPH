...
One of the most important steps in this stage when it comes to development of Open Science related learning materials is to align the syllabus with Skills profiles, as described for example in [@whyte_2023_8101903]. These profiles define the skills and competences necessary for a set of identified profiles related to Open Science. Use skills and competency profiles describing your target audience as a starting place for the development of the concept map.

Best practices [@R88] are to facilitate a rich learning experience by defining a modular structure that will be composed of the essential knowledge necessary to achieve the learning objectives augmented with additional resources for further elaboration for learners that are interested in obtaining more in-depth knowledge on a given topic. In summary, the course syllabus is a document that presents the purpose of the learning content with precise description of what is to be learnt, how and when under the assumption of the defined prerequisites. The Framework for Open and Reproducible Research Training (FORRT) offers a list of Open Science syllabi [@R89] in various formats and detail level.
